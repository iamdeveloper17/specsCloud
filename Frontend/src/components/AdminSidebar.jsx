...
import { FaHome, FaFolderOpen, FaUser, FaSignOutAlt, FaFileAlt, FaFolder } from 'react-icons/fa';
...
const AdminSidebar = ({ onClose }) => {
  ...
  const navItems = [
    ...
    { name: 'Specification', icon: <FaFileAlt />, path: '/admin-specification' },
    { name: 'Folder', icon: <FaFolder />, path: '/admin-folder' },
  ...
  return (
    <aside className="h-full sm:min-h-screen w-full max-w-xs sm:w-64 bg-gray-300 text-white flex flex-col justify-between shadow-lg">
      {/* Logo */}
      <div>
